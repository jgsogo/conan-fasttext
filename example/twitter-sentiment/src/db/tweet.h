...
namespace db {
    ...
    typedef std::tuple<time_t, std::string, std::string> Tweet; // timestamp_ms, hashtags, text
    ...
    public:
        ...
        void insert(time_t timestamp, const std::string& hashtags, const std::string& message);
